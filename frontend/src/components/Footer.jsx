const Footer = () => {
  return (
    <div className="flex flex-col w-full">
      ...
      <footer className="bg-color_blue1 text-white py-2 w-full">
        <div className="max-w-7xl mx-auto px-4">
          {/* Footer Content */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
            {/* PARKTEK Section */}
            <div>
              <h3 className="font-semibold text-lg mb-1">PARKTEK</h3>
            ...
            {/* Products Section */}
            <div>
              <h3 className="font-semibold text-lg mb-1">Products</h3>
              <ul className="space-y-0.5">
